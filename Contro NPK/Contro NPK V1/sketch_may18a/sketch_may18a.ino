...
status1 = status(status1); 
   ...
   Serial.println(pumP);
      Serial.print("BUTTON K  ");
   Serial.println(pumK);


   Serial.print("ค่าSetNนอกฟังชั่น ");
   Serial.println(DatasetN);

   Serial.print("ค่าSetPนอกฟังชั่น ");
   Serial.println(DatasetP);

   Serial.print("ค่าSetKนอกฟังชั่น ");
   Serial.println(DatasetK);
   
   Serial.print("สถานะ Auto ");
   Serial.println(autonpk);

   Serial.print("ค่าNนอกฟังชั่น ");
   Serial.println(N);

   Serial.print("ค่าPนอกฟังชั่น ");
   Serial.println(P);

   Serial.print("ค่าKนอกฟังชั่น ");
   Serial.println(K);
   */
